#!/usr/bin/env python3
# edit from https://github.com/TomHeaven/crypten_cifar10_cuda_distributed/blob/main/distributed_launcher.py thanks!
...
class MultiMachineLauncher:
    # run_process_fn will be run in subprocesses.
    def __init__(self, world_size, rank, master_address, master_port, run_process_fn, fn_args=None):
